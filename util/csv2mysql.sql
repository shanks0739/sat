...
insert ignore into t_h_price(code,date,time, cur,opening,highest,lowest,volume)  select code,date,'000000',cur,opening,highest,lowest,volume from t_h_sina where date>='2014-12-01';
